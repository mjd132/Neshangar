...
public partial class App : Application
{
    ...
    private void ApplyTheme()
    {
        ...
        if (isDarkMode)
        {
            themeDict.Source = new Uri("/Resources/Themes/DarkTheme.xaml", UriKind.Relative);
        }
        else
        {
            themeDict.Source = new Uri("/Resources/Themes/LightTheme.xaml", UriKind.Relative);
        }
        ...
        {
            Source = new Uri("/Resources/Styles/GlobalStyles.xaml", UriKind.Relative)
        });
    }
    ...
    private void OnConnectionClosed()
    {
        ...
        {
            ServiceProvider.GetService<ChangeStatus>()?.Hide();
            ServiceProvider.GetService<UsersList>()?.Hide();
